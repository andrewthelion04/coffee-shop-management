...
CoffeeShop::CoffeeShop(string coffee_shop_address, string coffee_shop_city,
                       string coffee_shop_size) : coffee_shop_address(
                                                      coffee_shop_address), coffee_shop_city(coffee_shop_city),
                                                  coffee_shop_size(coffee_shop_size) {
}

// getters for the coffee shop address, city and size
string CoffeeShop::get_coffee_shop_address() {
    return coffee_shop_address;
}


string CoffeeShop::get_coffee_shop_city() {
    return coffee_shop_city;
}

string CoffeeShop::get_coffee_shop_size() {
    return coffee_shop_size;
}

// method to clear the new products vector
void CoffeeShop::clear_new_products() {
    new_products.clear();
}

// method to clear the orders vector
void CoffeeShop::clear_orders() {
    orders.clear();
}

// method to clear the special events vector
void CoffeeShop::clear_special_events() {
    special_events.clear();
}

//methods to add, remove and get employees, products, orders and special events

void CoffeeShop::add_employee() {
...
void CoffeeShop::remove_employee() {
...
void CoffeeShop::add_product() {
    ...
    is_product_price_valid(purchase_price);

    cout << "Enter the sale price of the product: ";
    cin >> sale_price;
    cin.ignore();

    is_product_price_valid(sale_price);
...
void CoffeeShop::delete_product() {
...
bool CoffeeShop::check_minimum_staff_required() {
...
void CoffeeShop::client_order(Client *client) {
...
void CoffeeShop::subtract_product(string product_name, int quantity) {
...
void CoffeeShop::add_special_event() {
    // method to add a special event to the coffee shop (in the .csv file and in the vector)
...
void CoffeeShop::remove_special_event() {
...
void CoffeeShop::display_special_events() {
...
void CoffeeShop::display_special_event_requirements() {
...
void CoffeeShop::display_employees_information() {
...
void CoffeeShop::display_employees_shifts() {
...
void CoffeeShop::display_products() {
...
void CoffeeShop::is_salary_valid(string salary) {
...
void CoffeeShop::is_quantity_valid(string quantity) {
    // method to check if the salary is valid
    for (char &c: quantity) {
        if (!isdigit(c)) {
            throw "Invalid quantity! Please use only digits!";
        }
    }
}


void CoffeeShop::is_product_price_valid(string product_price) {
    // method to check if the salary is valid
    for (char &c: product_price) {
        if (!isdigit(c)) {
            throw "Invalid price! Please use only digits!";
        }
    }
}

void CoffeeShop::is_shift_valid(string shift1, string shift2) {
...
bool CoffeeShop::is_name_valid(string name) {
...
double CoffeeShop::calculate_total_salaries() {
...
double CoffeeShop::calculate_total_bills() {
...
double CoffeeShop::calculate_total_sales() {
...
double CoffeeShop::calculate_total_acquisitions() {
...
double CoffeeShop::calculate_total_cost_special_events() {
...
double CoffeeShop::calculate_total_sales_special_events() {
...
CoffeeShop::~CoffeeShop() = default; // destructor
