...
string CoffeeShopManager::get_current_day() const {
    return current_date;
}

bool CoffeeShopManager::valid_city_name(const string &city_name) {
...
void CoffeeShopManager::add_coffee_shop() {
    ...
    cout << "Eligible cities: Bucuresti, Cluj-Napoca, Timisoara, Iasi, Brasov" << endl;
...
void CoffeeShopManager::remove_coffee_shop() {
...
void CoffeeShopManager::display_coffee_shops() {
...
CoffeeShop *CoffeeShopManager::choose_coffee_shop() {
...
void CoffeeShopManager::generate_daily_reports() {
...
void CoffeeShopManager::print_daily_reports() {
...
void CoffeeShopManager::print_detailed_daily_reports() {
...
void CoffeeShopManager::get_today_date() {
...
void CoffeeShopManager::go_to_next_day() {
...
CoffeeShopManager::~CoffeeShopManager() = default;
