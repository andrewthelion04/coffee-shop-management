...
void initialize_employees_file(string language){
    ...
    if(language == "English") {
        ...
        employees_file<<"oras_cafenea,adresa_cafenea,nume_angajat,prenume_angajat,pozitie,salariu,ora_incepere_tura,ora_sfarsit_tura"<<endl;
    }
...
void initialize_special_events_file(string language){
    ...
    if(language == "English") {
        ...
        special_events_file<<"oras_cafenea,adresa_cafenea,nume_eveniment,descriere_eveniment,ora_inceput,costuri_eveniment"<<endl;
    }
